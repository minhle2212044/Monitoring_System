...
export const API_ENDPOINTS = {
  ...
  // User endpoints
  USER: {
    GET_ALL: `${API_URL}/api/v1/user`,
    GET_BY_ID: (id) => `${API_URL}/api/v1/user/${id}`,
    UPDATE: (id) => `${API_URL}/api/v1/user/${id}`,
    DELETE: (id) => `${API_URL}/api/v1/user/${id}`,
    UPDATE_PASSWORD: (id) => `${API_URL}/api/v1/user/${id}/change-password`,
  },
  // Notice endpoints
  NOTICE: {
